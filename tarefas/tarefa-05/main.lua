...
-- PROPRIEDADE: valor
-- TEMPO: compilação
-- EXPLICAÇÃO: o valor de LARGURA_TELA será definido na 
--compilação por ela ser global 
------------------------------------------------------------ 	
...
-- PROPRIEDADE: tipo
-- TEMPO: compilação
-- EXPLICAÇÃO: Como ALTURA_TELA é uma global e não há uma
-- definição explícita do tipo da variável temos que isso é
-- descoberto em tempo de compilação
------------------------------------------------------------
...
-- PROPRIEDADE: valor
-- TEMPO: design
-- EXPLICAÇÃO: false é uma escolha em tempo de design dos
--desenvolvedores da LUA
------------------------------------------------------------      
...
-- TEMPO: design
-- EXPLICAÇÃO: O operador "+" usado para adição foi uma
-- escolha em tempo de design da linguagem
------------------------------------------------------------  
...
-- PROPRIEDADE: valor
-- TEMPO: execução
-- EXPLICAÇÃO: o valor de y só será descoberto quando a função
-- "da_tiro()" for chamada 
------------------------------------------------------------ 		
...
-- TEMPO: execução
-- EXPLICAÇÃO: key e tiro são locais e seus endereços 
-- só são determinados no tempo de execução do bloco for.
------------------------------------------------------------   
