...
-- Tarefa 07
-- Array com meteoros sendo criados com escopo global ao jogo
meteoros = {}


-- Tarefa 07
-- Meteoro sendo removido quando já passou pela área inferior da  da tela
-- do jogador( y = 480 px)
...
-- Tarefa 07
-- Meteoro sendo criado com a posiçao X randômica,
-- peso e deslocamento horizontal(esq->dir, centro, dir->esq) também randômicos
